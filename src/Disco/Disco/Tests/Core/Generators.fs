...
module Generators =
  ...
  let errGen =
    [ Gen.constant DiscoError.OK
      Gen.map      DiscoError.GitError     (Gen.two stringGen)
      Gen.map      DiscoError.ProjectError (Gen.two stringGen)
      Gen.map      DiscoError.SocketError  (Gen.two stringGen)
      Gen.map      DiscoError.ParseError   (Gen.two stringGen)
      Gen.map      DiscoError.IOError      (Gen.two stringGen)
      Gen.map      DiscoError.AssetError   (Gen.two stringGen)
      Gen.map      DiscoError.RaftError    (Gen.two stringGen)
      Gen.map      DiscoError.ClientError  (Gen.two stringGen)
      Gen.map      DiscoError.Other        (Gen.two stringGen) ]
    |> Gen.oneof
