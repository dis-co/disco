...
public sealed class IOBox : Table {
  ...
  public Iris.Types.Slice GetSlices(int j) { return GetSlices(new Iris.Types.Slice(), j); }
  public Iris.Types.Slice GetSlices(Iris.Types.Slice obj, int j) { int o = __offset(36); return o != 0 ? obj.__init(__indirect(__vector(o) + j * 4), bb) : null; }
  ...
  public static VectorOffset CreateSlicesVector(FlatBufferBuilder builder, Offset<Iris.Types.Slice>[] data) { builder.StartVector(4, data.Length, 4); for (int i = data.Length - 1; i >= 0; i--) builder.AddOffset(data[i].Value); return builder.EndVector(); }
