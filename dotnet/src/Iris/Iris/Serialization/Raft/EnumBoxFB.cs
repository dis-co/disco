...
public struct EnumBoxFB : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static EnumBoxFB GetRootAsEnumBoxFB(ByteBuffer _bb) { return GetRootAsEnumBoxFB(_bb, new EnumBoxFB()); }
  public static EnumBoxFB GetRootAsEnumBoxFB(ByteBuffer _bb, EnumBoxFB obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public void __init(int _i, ByteBuffer _bb) { __p.bb_pos = _i; __p.bb = _bb; }
  public EnumBoxFB __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public EnumPropertyFB? Properties(int j) { int o = __p.__offset(12); return o != 0 ? (EnumPropertyFB?)(new EnumPropertyFB()).__assign(__p.__indirect(__p.__vector(o) + j * 4), __p.bb) : null; }
  public int PropertiesLength { get { int o = __p.__offset(12); return o != 0 ? __p.__vector_len(o) : 0; } }
  public EnumSliceFB? Slices(int j) { int o = __p.__offset(14); return o != 0 ? (EnumSliceFB?)(new EnumSliceFB()).__assign(__p.__indirect(__p.__vector(o) + j * 4), __p.bb) : null; }
