...
public struct LogEntryFB : IFlatbufferObject
{
  ...
  public ApiActionFB? Data { get { int o = __p.__offset(10); return o != 0 ? (ApiActionFB?)(new ApiActionFB()).__assign(__p.__indirect(o + __p.bb_pos), __p.bb) : null; } }
  ...
  public static void AddData(FlatBufferBuilder builder, Offset<ApiActionFB> DataOffset) { builder.AddOffset(3, DataOffset.Value, 0); }
