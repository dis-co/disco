...
public sealed class ByteBoxFB : Table {
  public static ByteBoxFB GetRootAsByteBoxFB(ByteBuffer _bb) { return GetRootAsByteBoxFB(_bb, new ByteBoxFB()); }
  public static ByteBoxFB GetRootAsByteBoxFB(ByteBuffer _bb, ByteBoxFB obj) { return (obj.__init(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public ByteBoxFB __init(int _i, ByteBuffer _bb) { bb_pos = _i; bb = _bb; return this; }
  ...
  public ByteSliceFB GetSlices(int j) { return GetSlices(new ByteSliceFB(), j); }
  public ByteSliceFB GetSlices(ByteSliceFB obj, int j) { int o = __offset(12); return o != 0 ? obj.__init(__indirect(__vector(o) + j * 4), bb) : null; }
