...
public sealed class NodeFB : Table {
  ...
  public bool Voting { get { int o = __offset(12); return o != 0 ? 0!=bb.Get(o + bb_pos) : (bool)false; } }
  public bool VotedForMe { get { int o = __offset(14); return o != 0 ? 0!=bb.Get(o + bb_pos) : (bool)false; } }
  public NodeStateFB State { get { int o = __offset(16); return o != 0 ? (NodeStateFB)bb.Get(o + bb_pos) : NodeStateFB.JoiningFB; } }
  public ulong NextIndex { get { int o = __offset(18); return o != 0 ? bb.GetUlong(o + bb_pos) : (ulong)0; } }
  public ulong MatchIndex { get { int o = __offset(20); return o != 0 ? bb.GetUlong(o + bb_pos) : (ulong)0; } }
