...
public sealed class FloatBoxFB : Table {
  public static FloatBoxFB GetRootAsFloatBoxFB(ByteBuffer _bb) { return GetRootAsFloatBoxFB(_bb, new FloatBoxFB()); }
  public static FloatBoxFB GetRootAsFloatBoxFB(ByteBuffer _bb, FloatBoxFB obj) { return (obj.__init(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public FloatBoxFB __init(int _i, ByteBuffer _bb) { bb_pos = _i; bb = _bb; return this; }
  ...
  public FloatSliceFB GetSlices(int j) { return GetSlices(new FloatSliceFB(), j); }
  public FloatSliceFB GetSlices(FloatSliceFB obj, int j) { int o = __offset(22); return o != 0 ? obj.__init(__indirect(__vector(o) + j * 4), bb) : null; }
